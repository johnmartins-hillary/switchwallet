        ...
        <section className="mx-5">
            <div className="container max-w-7xl rounded-2xl mx-auto py-20 bg-gradient my-20 text-center px-5">
                ...
                <div className="flex justify-center mt-8 space-x-3">
                    <a href="/register" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-60 px-6 py-3 mb-3 text-black bg-white sm:mb-0 sm:w-auto font-dmsans text-lg font-bold rounded-full md:w-56 shadow-md">Create Account</a>
                </div>
            </div>
        </section>
    )
