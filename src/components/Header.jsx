    ...
    return (
        <header className="sticky top-0 left-0 right-0 bg-white z-50">
            <div className="container mx-auto px-4">
                <div className="flex justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        <a href="https://docs.switchwallet.io/" target="_blank" rel="noopener noreferrer" className={`py-5 px-3 text-xl font-dmsans font-semibold hover:text-gradient transition duration-300 ease-in ${pathname === '/documentation' ? 'text-gradient' : ''}`}>Documentation</a>
                        <a href="mailto:Switchwallet.xend@gmail.com?" target="_blank" rel="noopener noreferrer" className={`py-5 px-3 text-xl font-dmsans font-semibold hover:text-gradient transition duration-300 ease-in ${pathname === '/documentation' ? 'text-gradient' : ''}`}>Help</a>
                        <a href="https://integrations.switchwallet.io/" target="_blank" rel="noopener noreferrer" className={`py-5 px-3 text-xl font-dmsans font-semibold hover:text-gradient transition duration-300 ease-in ${pathname === '/login' ? 'text-gradient' : ''}`}>Login</a>
                        ...
                        <a href="https://sandbox-integrations.switchwallet.io/" target="_blank" rel="noopener noreferrer"><button type='button' className='p-3 bg-[#2042B8] hover:bg-[#2546bd] w-56 rounded-full text-white cursor-pointer font-dmsans font-semibold md:ml-0 ml-4 md:my-0 my-5 text-xl'>Sandbox</button></a>
                    </div>
            ...
            <div className="mobile-menu hidden md:hidden">
                ...
                <a href="https://docs.switchwallet.io/" target="_blank" rel="noopener noreferrer" className={`block pt-2 pb-3  px-4 text-xl font-dmsans font-semibold hover:text-gradient transition duration-300 ease-in ${pathname === '/documentation' ? 'text-gradient' : ''}`}>Documentation</a>
                <a href="mailto:Switchwallet.xend@gmail.com?" target="_blank" rel="noopener noreferrer" className={`block pt-2 pb-3  px-4 text-xl font-dmsans font-semibold hover:text-gradient transition duration-300 ease-in ${pathname === '/Help' ? 'text-gradient' : ''}`}>Help</a>
                <a href="https://integrations.switchwallet.io/" target="_blank" rel="noopener noreferrer" className={`block pt-2 pb-3 px-4 text-xl font-dmsans font-semibold hover:text-gradient focus:text-gradient transition duration-300 ease-in ${pathname === '/login' ? 'text-gradient' : ''}`}>Login</a>
                <a href="https://sandbox-integrations.switchwallet.io/create-account" target="_blank" rel="noopener noreferrer"><button type='button' className='p-3 bg-[#2042B8] hover:bg-[#2546bd] w-56 rounded-full text-white cursor-pointer font-dmsans font-semibold md:ml-0 ml-4 md:my-0 my-5 text-xl'>Create Account</button></a>
                <a href="https://sandbox-integrations.switchwallet.io/" target="_blank" rel="noopener noreferrer"><button type='button' className='p-3 bg-[#2042B8] hover:bg-[#2546bd] w-56 rounded-full text-white cursor-pointer font-dmsans font-semibold md:ml-0 ml-4 md:my-0 my-5 text-xl'>Sandbox</button></a>
            </div> 
        </header>
