    ...
    return (
        <header className="sticky top-0 left-0 right-0 bg-white z-50">
            <div className="container mx-auto px-4">
                <div className="flex justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        <a href="https://xend-finance.gitbook.io/switchwallet/" target="_blank" rel="noopener noreferrer" className={`py-5 px-3 text-lg font-dmsans font-medium hover:text-gradient transition duration-300 ease-in ${pathname === '/developers' ? 'text-gradient' : ''}`}>Documentation</a>
            ...
            <div className="mobile-menu hidden md:hidden">
                <Link to="/" className={`block px-4 text-lg font-dmsans font-medium hover:text-gradient focus:text-gradient transition duration-300 ease-in ${pathname === '/' ? 'text-gradient' : ''}`}>Home</Link>
                <Link to="/pricing" className={`block py-2 md:py-0 px-4 text-lg font-dmsans font-medium hover:text-gradient focus:text-gradient transition duration-300 ease-in ${pathname === '/pricing' ? 'text-gradient' : ''}`}>Pricing</Link>
                <a href="https://xend-finance.gitbook.io/switchwallet/" target="_blank" rel="noopener noreferrer" className={`my-5 px-4 text-lg font-dmsans font-medium hover:text-gradient transition duration-300 ease-in ${pathname === '/developers' ? 'text-gradient' : ''}`}>Documentation</a>
