                            ...
                            <div className='space-y-5'>
                                <div className='flex gap-5'>
                                    <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.2753 10.0121L10.7273 11.8511C11.3947 12.3516 12.3351 12.2533 12.8845 11.6254L18.2722 5.46802" stroke="#767676" stroke-width="2.53608" strokeLinecap="round" />
                                        <path d="M19.1809 11.8296C19.1809 13.5386 18.6455 15.2047 17.6501 16.5938C16.6546 17.983 15.249 19.0254 13.6307 19.5748C12.0124 20.1241 10.2627 20.1528 8.62724 19.6567C6.99182 19.1606 5.55287 18.1647 4.51249 16.8088C3.47211 15.453 2.88256 13.8053 2.82664 12.0972C2.77073 10.3891 3.25125 8.70638 4.20073 7.28539C5.1502 5.8644 6.52093 4.77651 8.1204 4.17451C9.71988 3.57251 11.4677 3.48665 13.1185 3.92897" stroke="#767676" stroke-width="2.53608" strokeLinecap="round" />
                                    </svg>
            ...
            <section className="max-w-7xl mx-auto p-5">
                <div className="rounded-3xl mb-20 flex-row bg-gradient-plus text-white flex items-center justify-center">
                    ...
                    <div className="lg:w-2/5 w-full lg:flex lg:flex-row hidden items-center justify-center">
                        ...
                        <a href="/register" target="_blank" rel="noopener noreferrer" className='absolute'>
