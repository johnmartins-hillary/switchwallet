                        ...
                        <div className="w-full md:w-1/2 md:px-3">
                            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                ...
                                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                                    <a href="https://integrations.switchwallet.io/create-account" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full px-6 py-3 mb-3 text-white bg-[#2042B8] sm:mb-0 hover:bg-[#2546bd] sm:w-auto font-dmsans text-lg font-bold rounded-full md:w-56">Create Account</a>
