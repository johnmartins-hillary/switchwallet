        ...
        <Layout>
                    ...
                    <div className="flex flex-wrap items-center sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-3">
                            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                <h1 className="text-3xl md:text-6xl md:text-left text-gradient font-bold tracking-tight md:mt-0 mt-10 mb-14 capitalize">Cheapest Wallet Infrastructure for your business</h1>
                                <p className="mx-auto text-base text-black sm:max-w-md lg:text-xl md:max-w-3xl">Switch Wallet is an enterprise-grade wallet provision service. Leveraging our technology, you can securely process transactions in a fraction of the time while saving cost.</p>
                                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                                    <a href="https://stg-integrations.switchwallet.io/auth/register" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full px-6 py-3 mb-3 text-white bg-[#2042B8] sm:mb-0 hover:bg-[#2546bd] sm:w-auto font-dmsans text-lg font-bold rounded-full md:w-56">Create Account</a>
            ...
            <section className="py-4 my-12 md:my-0">
                <div className='text-center md:my-32'>
                    <h2 className="box-border m-0 text-2xl font-semibold leading-tight tracking-tight text-black border-solid sm:text-4xl md:text-5xl">Simple and Transparent Service</h2>
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row mt-12 md:mt-0">
                    ...
                    <div className="flex flex-col w-full lg:w-2/4 p-8">
                        ...
                        <p className="font-dmsans font-normal text-base md:text-lg my-2 md:my-4 text-black">Digital assets are the new world currency. Switch Wallet provides an API infrastructure service that allows you to transact digital assets, across multiple chains and guarantee high-level security for your transactions.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="md:py-4">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row my-12 md:my-20">
                    <div className="flex flex-col w-full lg:w-3/5 p-8 md:order-1 order-2">
                        ...
                        <p className="font-dmsans font-normal text-base md:text-lg my-2 md:my-4 text-black">We help businesses save time and money building solutions on the blockchain. With our easy and simple setup process, we'll have you enjoying our service in no time. Switch Wallet offers the best competitive rates, fast & crypto transactions, and a variety of customizable features to help your business succeed.</p>
                    </div>
            ...
            <section className="py-4">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row mb-12 md:mb-20">
                    ...
                    <div className="flex flex-col w-full lg:w-2/4 p-8">
                        ...
                        <p className="font-dmsans font-normal text-base md:text-lg my-2 md:my-4 text-black">Switch Wallet supports transactions in multiple cryptocurrencies such as BUSD, USDT, USDC,  DAI and others.</p>
                    </div>
                </div>
            </section>
