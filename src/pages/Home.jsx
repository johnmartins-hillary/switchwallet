        ...
        <Layout>
            ...
            <section>
                <div className="container flex flex-col-reverse items-center px-6 mx-auto md:mt-20 mt-10 space-y-0 md:space-y-0 md:flex-row">
                    <div className="flex flex-col md:w-1/2">
                        <h1 className="max-w-md text-2xl font-rubik font-bold text-gradient md:text-4xl md:text-left md:mt-0 mt-10 mb-14">
            ...
            <section className="py-4 my-12 md:my-36">
                <div className='text-center md:my-32'>
                    ...
                    <p className="text-sm md:text-lg my-2 md:my-4 font-dmsans font-normal text-[#52575C]">Built for your Business to connect more customer</p>
                </div>
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row mt-12 md:mt-0">
                    ...
                    <div className="flex flex-col w-full lg:w-2/4 p-8">
                        ...
                        <p className="text-sm md:text-lg my-2 md:my-4 font-dmsans font-normal text-[#52575C]">Start accepting cryptocurrencies using Switch Wallet for on your business and eCommerce site</p>
                    </div>
                </div>
            </section>
            ...
            <section className="md:py-4">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row mb-12 md:mb-36">
                    <div className="flex flex-col w-full lg:w-2/5 p-8 md:order-1 order-2">
                        ...
                        <p className="text-sm md:text-lg my-2 md:my-4 font-dmsans font-normal text-[#52575C]">Accept Fiat and Get Paid in Crypto and vice versa from multiple Crypto currencies.</p>
                    </div>
            ...
            <section className="py-4">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row mb-12 md:mb-36">
                    ...
                    <div className="flex flex-col w-full lg:w-2/4 p-8">
                        <p className="text-3xl md:text-5xl my-4 leading-relaxed md:leading-snug font-rubik font-bold text-[#444444]">Supports multiple currencies</p>
                        <p className="text-sm md:text-lg my-2 md:my-4 font-dmsans font-normal text-[#52575C]">Switch Wallet support transactions in multiple such as BUSD, BTC, ETH, SHIBA, and up to 100+ Crypto</p>
                    </div>
                </div>
            </section>
            ...
            <section className='md:my-60 px-10 md:px-0'>
                ...
                <div className="max-w-6xl flex flex-col-reverse items-center mx-auto space-y-0 md:space-y-0 md:flex-row md:py-20">
                    <div className="flex flex-col md:w-1/2">
                        ...
                        <p className="max-w-lg md:text-left font-dmsans text-lg font-normal my-10 text-[#757575]">We are backed by a few of the best. A product of XendFinance and has been steadily improving ever since. You can use Switch Wallet to exchange cryptocurrencies to FIAT currencies (e.g., EUR, USD, GBP, etc.). We make it easy to securely store your wallet on our server and provide you with the ultimate user experience.</p>
                    </div>
                </div>
            </section>
