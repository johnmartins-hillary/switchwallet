                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs><linearGradient id="paint0_linear_269_548" x1="-2.07123" y1="0.010849" x2="14.9035" y2="22.5745" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient></defs>
                                </svg>
                            </div>
                        </div>
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs><linearGradient id="paint0_linear_269_553" x1="0.160726" y1="2.00808" x2="15.3574" y2="20.8073" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient></defs>
                                </svg>
                            </div>
                        </div>
                        <div className="w-10/12">
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_269_559" x1="-2.07123" y1="0.00718739" x2="7.27412" y2="18.758" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                        <linearGradient id="paint1_linear_269_559" x1="2.61164" y1="8.78891" x2="5.30931" y2="12.8484" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                    </defs>
                                </svg>
                            </div>
                        </div>
                                ...
                                <svg width="30" height="30" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_269_566" x1="-1.07123" y1="1.00671" x2="7.28397" y2="18.9682" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                        <linearGradient id="paint1_linear_269_566" x1="3.15023" y1="5.32371" x2="4.93862" y2="12.7802" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" />
                                        </linearGradient>
                                    </defs>
                                </svg>
                            </div>
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs><linearGradient id="paint0_linear_269_573" x1="-2.07123" y1="0.00867052" x2="10.3992" y2="20.7498" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient></defs>
                                </svg>
                            </div>
                        </div>
                        <div className="w-10/12">
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18.4991 6.02103C18.2541 8.78625 15.7492 11.0421 12.9993 11.0421C10.2494 11.0421 7.74018 8.78678 7.49956 6.02103C7.24957 3.1444 9.68697 1 12.9993 1C16.3117 1 18.7491 3.1967 18.4991 6.02103Z" stroke="url(#paint0_linear_269_578)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_269_578" x1="6.52962" y1="1.00479" x2="13.9378" y2="11.2565" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                        <linearGradient id="paint1_linear_269_578" x1="-1.07123" y1="14.3934" x2="2.27302" y2="26.4718" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                    </defs>
                                </svg>
                            </div>
                        </div>
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 26 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M22.4286 1H3.57143C2.15127 1 1 1.96347 1 3.15196V17.4984C1 18.6869 2.15127 19.6503 3.57143 19.6503H22.4286C23.8487 19.6503 25 18.6869 25 17.4984V3.15196C25 1.96347 23.8487 1 22.4286 1Z" stroke="url(#paint0_linear_269_585)" stroke-linejoin="round" />
                                    <path d="M9.25 9.15948H12.25M4.75 4.13818L8.5 6.64883L4.75 9.15948V4.13818Z" stroke="url(#paint1_linear_269_585)" stroke-linecap="round" stroke-linejoin="round" />
                                    <defs>
                                        <linearGradient id="paint0_linear_269_585" x1="-1.07123" y1="1.0089" x2="11.8809" y2="21.9987" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                        <linearGradient id="paint1_linear_269_585" x1="4.10274" y1="4.14058" x2="7.33697" y2="10.2241" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient>
                                    </defs>
                                </svg>
                            </div>
                        </div>
                        ...
                        <div className="w-20 h-20 relative mr-5">
                            ...
                            <div className="absolute text-white rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
                                <svg width="30" height="30" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs><linearGradient id="paint0_linear_269_592" x1="-1.55342" y1="0.00878468" x2="12.448" y2="17.2474" gradientUnits="userSpaceOnUse"><stop stop-color="#FF6600" /><stop offset="1" stop-color="#2042B8" /></linearGradient></defs>
                                </svg>
                            </div>
                        </div>
                        <div className="w-10/12">
                        ...
                        <div className="mb-8 tab">
                            <div className="border relative rounded-2xl">
                                ...
                                <header className="flex justify-between items-center p-6 pl-8 pr-8 cursor-pointer select-none tab-label" htmlFor="chck1">
                                    <span className="font-dmsans font-medium text-xl text-slate-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit.?</span>
                                    <div className="flex items-center justify-center test">
                                        <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 2L8 7.02124L14 2" stroke="url(#paint0_linear_269_596)" stroke-width="2" stroke-miterlimit="10" stroke-linecap="square" />
                                            <defs>
